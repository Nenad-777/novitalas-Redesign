...
# Download the public-domain 1899 Renoir self-portrait from Wikimedia Commons.
news = ROOT / 'client/public/news'
news.mkdir(parents=True, exist_ok=True)
image_url = (
    'https://upload.wikimedia.org/wikipedia/commons/7/7f/'
    'Pierre-Auguste_Renoir_-_Autoportrait%2C_1899.jpg'
)
request = urllib.request.Request(
    image_url,
    headers={'User-Agent': 'NoviTalasPublisher/1.0 (novitalas.org)'},
)
with urllib.request.urlopen(request, timeout=30) as response:
    (news / 'renoir-self-portrait-1899.jpg').write_bytes(response.read())
...
nasa_entry = '''const ARTICLES: NasaPlanetaArticle[] = [\n  {\n    href: "/nasa-planeta/ko-krade-renoara-ako-ne-moze-da-ga-proda",\n    img: "/news/renoir-self-portrait-1899.jpg",\n    alt: "Autoportret Pjera-Ogista Renoara iz 1899. godine.",\n    imageCredit: "Pjer-Ogist Renoar, Autoportret, 1899 / Wikimedia Commons, javni domen",\n    title: "Ko krade Renoara ako ne može da ga proda?",\n    description:\n      "Dvojica lopova odnela su četiri Renoarove slike iz muzeja na Azurnoj obali. Dve su pronađene, dve su nestale. Ali prava misterija je čemu služi krađa dela koje je gotovo nemoguće prodati.",\n  },\n'''
