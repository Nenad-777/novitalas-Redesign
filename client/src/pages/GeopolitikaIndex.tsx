...
const IMAGES = {
  ...
  usaIranCrisis: "/news/usa-iran-crisis.jpg",
};
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <article className="md:col-span-2">
              ...
              >
                ...
                >
                  Nova migraciona pravila Evropske unije ulaze u primenu
                </h2>
                ...
                >
                  Novi evropski pakt menja pravila za azil, granice i deportacije,
                  uz zajedničke procedure i novi sistem solidarnosti među
                  državama članicama.
                </p>
            ...
            <article className="md:col-span-2">
              ...
              >
                ...
                >
                  <img
                    src={IMAGES.afganistanWoman}
                    alt="Protest za prava žena u Avganistanu"
                    className="w-full h-[260px] object-cover object-center block"
                    decoding="async"
                  />
                </div>
                ...
                >
                  Talibani otvorili vatru na protest za prava žena
                </h2>
            ...
            <article className="md:col-span-2">
              ...
              >
                ...
                >
                  <img
                    src={IMAGES.usaIranCrisis}
                    alt="Američki i iranski vojni sudar — kriza oko Ormuskog moreuza"
                    className="w-full h-[260px] object-cover object-center block"
                    decoding="async"
                  />
                </div>
                ...
                >
                  Tramp pokrenuo udare na Iran nakon obaranja američkog helikoptera
                </h2>
            ...
            <article className="md:col-span-2">
              ...
              >
                ...
                >
                  Posle dronova dolaze roboti: novo poglavlje rata u Ukrajini
                </h2>
            ...
            <article className="md:col-span-2">
              ...
              >
                ...
                >
                  <img
                    src={IMAGES.mertzUkraine}
                    alt="Evropska unija i Ukrajina u kontekstu predloga o pridruženom članstvu"
                    className="w-full h-[260px] object-cover object-center block"
                    decoding="async"
                  />
                </div>
                ...
                >
                  Evropa traži novu formulu za Ukrajinu
                </h2>
            ...
            <article className="md:col-span-2">
              ...
              >
                ...
                >
                  <img
                    src={IMAGES.putinEndWar}
                    alt="Ilustracija: Vladimir Putin i završnica rata u Ukrajini"
                    className="w-full h-[260px] object-cover object-center block"
                    decoding="async"
                  />
                </div>
                ...
                >
                  Putin govori o kraju rata: između nade i opreza
                </h2>
            ...
            {/* ✅ NAJNOVIJA VEST (Amerika povlači vojnike iz Nemačke) */}
            <article className="md:col-span-2">
              <Link
              ...
              >
                ...
                >
                  <img
                    src={IMAGES.usGermanSoldiers}
                    alt="Američki i nemački vojnici tokom zajedničke vežbe u Oberlausitzu, Nemačka"
                    className="w-full h-[260px] object-cover object-center block"
                    decoding="async"
                  />
                </div>
            ...
            <article className="md:col-span-2">
              ...
              >
                ...
                >
                  <img
                    src={IMAGES.bulgariaElections}
                    alt="Predsednički izbori u Bugarskoj"
                    className="w-full h-[260px] object-cover object-center block"
                    decoding="async"
                  />
                </div>
