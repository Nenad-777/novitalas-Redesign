  ...
  if (variant === "tile") {
    return (
      <article
        ...
        style={{ borderColor: isDark ? "#2a2a2e" : "#eee", backgroundColor: isDark ? "#17191f" : "#ffffff" }}
      >
        <Link href={href} className="block no-underline">
          ...
          <div className="p-3">
            ...
            <h3
              ...
              style={{ fontFamily: "'Lora', Georgia, serif", color: isDark ? "#e0ddd5" : "#111" }}
            >
              {title}
            </h3>
          </div>
    ...
    <article className="grid grid-cols-[1fr_112px] min-[390px]:grid-cols-[1fr_118px] gap-4 items-start">
      ...
      <Link href={href} className="block no-underline">
        <img
          ...
          style={{ borderColor: isDark ? "#2a2a2e" : "#eee", backgroundColor: isDark ? "#1a1c22" : "#f5f5f5" }}
          loading="lazy"
          decoding="async"
        />
      </Link>
