...
const PARAGRAPHS = [
  ...
  "Ipak, i pored formalnog otvaranja plovnog puta, situacija ostaje krhka. Ormuski moreuz i dalje ostaje jedna od ključnih tačaka globalne geopolitičke napetosti, a svaka promena bezbednosnih okolnosti u regionu može ponovo uticati na tokove trgovine, osiguranje transporta i cenu energenata.",
...
export default function IranOtvorioHormuskiMoreuzZaKomercijalniSaobracajTokomPrimirja() {
  return (
    <ArticleTemplate
      ...
      deck="Teheran je saopštio da je Ormuski moreuz otvoren za komercijalni saobraćaj tokom trajanja primirja, čime je privremeno smanjena bojazan od novog udara na globalno tržište energije."
      imageSrc={IMAGE_SRC}
