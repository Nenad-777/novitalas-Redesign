...
const PARAGRAPHS = [
  ...
  "Komentar: Ako je prethodna decenija bila obeležena trkom za dominaciju u oblasti veštačke inteligencije, naredna bi mogla ostati upamćena kao period u kojem je ta inteligencija dobila telo. Humanoidni roboti više nisu tema naučne fantastike, već sledeća velika tehnološka platforma oko koje se formiraju novi industrijski i geopolitički savezi. Za mnoge države, pitanje više nije kako razviti robota, već kako ne zaostati u trci koja je već počela.",
];
