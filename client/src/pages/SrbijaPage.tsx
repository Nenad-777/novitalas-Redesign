...
const IMAGES = {
  koJePucaoUSrbiju: "/news/ko-je-pucao-u-srbiju.jpg",
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <article>
              ...
              >
                ...
                >
                  <img
                    src={IMAGES.koJePucaoUSrbiju}
                    alt="Ko je pucao u Srbiju — zvučni top, protest 15. marta"
                ...
                >
                  Događaji od 15. marta i incident sa navodnim „zvučnim topom"
                  pokrenuli su reakcije Evropskog suda za ljudska prava i
                  specijalnih izvestilaca UN, dok pitanja o odgovornosti ostaju
                  otvorena.
                </p>
